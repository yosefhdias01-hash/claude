...
- Workspace ID: `0f75911a-03a9-4aad-a444-6f09534d8d72`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/0f75911a-03a9-4aad-a444-6f09534d8d72.
...
2. `npx ngodingpakeai connect --workspace 0f75911a-03a9-4aad-a444-6f09534d8d72 --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/0f75911a-03a9-4aad-a444-6f09534d8d72. Only pass on links the CLI actually printed — never assemble one from an id yourself.
